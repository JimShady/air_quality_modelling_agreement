...
```
```{r no2_stats, echo=F}
kable(modStats(mydata = merged_data, mod = 'no2_model', obs = 'no2_monitor')) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r pm25_stats, echo=F}
kable(modStats(mydata = merged_data, mod = 'pm25_model', obs = 'pm25_monitor')) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r pm10_stats, echo=F}
kable(modStats(mydata = merged_data, mod = 'pm10_model', obs = 'pm10_monitor')) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r so2_stats, echo=F}
kable(modStats(mydata = merged_data, mod = 'so2_model', obs = 'so2_monitor')) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
